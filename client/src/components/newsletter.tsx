...
export default function Newsletter() {
  return (
    <div className="flex items-center justify-center">
      <section className="relative w-full bg-white overflow-hidden rounded-2xl max-w-xl pt-12 pb-16 sm:py-30 mx-6">
        {/* <img
          src={newsletter}
          ...
          <form className="flex gap-5 justify-center mx-4">
            <div className="relative w-full max-w-xl">
              <input
                ...
                className="w-full bg-transparent border border-gray-300 text-black placeholder-[#989797] px-4 pr-16 py-[0.785rem] rounded-full outline-none focus:ring-2 focus:ring-gray-100 transition"
              />
              <button
                type="submit"
