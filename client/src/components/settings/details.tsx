  ...
  return (
    <div className="max-w-2xl mx-8 md:mx-auto bg-white mt-6">
      ...
      <div className="p-6 space-y-8">
        ...
        <div className="flex justify-between items-center border-b border-gray-200 pb-2">
          <div>
            <p className="text-lg text-gray-600">Display name</p>
        ...
        <div className="flex justify-between items-center border-b border-gray-200 pb-2">
          <div>
            <p className="text-lg text-gray-600">Country of residence</p>
        ...
        <div className="pt-6">
          ...
          <button
            onClick={() => alert("Account deletion flow to be implemented")}
            className="font-semibold underline underline-offset-[3px] text-red-500 mt-1"
          >
