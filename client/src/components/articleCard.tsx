...
export default function FrontPageArticlesCard() {
  const frontPageArticles = articles["Front Page"] || [];
      ...
      {frontPageArticles.map((article) => (
        ...
        >
          ...
          <div className="flex-1 p-5 flex flex-col">
            ...
            <p className="text-[#767676] leading-5 mb-6 flex-1 line-clamp-5">
              {article.description}
            </p>
            ...
            <div className="flex justify-between pt-4 border-t border-gray-200">
              ...
              <div className="space-x-4 flex flex-row">
                <BookmarkIcon
                  ...
                  className="size-5 cursor-pointer active:scale-90 transition-transform"
                />{" "}
