...
const cities = [
  {
    title: "1. Copenhagen, Denmark — Where Waste Powers Homes and Skiers",
    img: copenhill,
  ...
  {
    title: "5. Beijing, China — Scaling Up Waste-to-Energy at National Level",
    img: beijing,
  ...
  {
    title: "7. Manila, Philippines — From Wasteland to Waste-to-Energy Model",
    img: plant,
