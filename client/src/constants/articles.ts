...
const articles = [
  ...
  // {
  //   id: 9,
  //   title: "The Deepest Cave Ever Explored",
  //   category: "Earth",
  //   date: "December 18, 2024",
  //   author: "Sasha Wells",
  //   img: cave,
  //   description:
  //     "A team of explorers descended into a chasm so deep their instruments began malfunctioning. What they recorded at the final depth still has geologists debating today...",
  // },
];
